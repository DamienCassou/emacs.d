...
(use-package ledger-import
  ...
  :init
  (progn
    (setq ledger-import-boobank-import-from-date "2020-04-01")
...
(use-package finsit-prodigy
  ...
  :config
  (progn
    (add-to-list 'finsit-prodigy-remotes '("boxes" "http://192.168.122.88:80"))
...
(use-package em-term
  ...
  (progn
    (setq eshell-visual-commands
          '("bower" "bluetoothctl" "htop" "jest" "less" "more" "ncdu" "nmtui" "npm" "pinentry-curses" "ssh" "top" "vim" "watch"))
